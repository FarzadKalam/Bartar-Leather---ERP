  ...
  const handleSubmit = async (values: {
    ...
    try {
      ...
      if (error && error.code === "PGRST204") {
        ...
        ({ error } = await supabase.from("customers").insert(fallbackPayload));
      }
      ...
      <div className="mx-auto w-full max-w-3xl">
        <div className="rounded-[28px] border border-amber-100/70 bg-white/95 shadow-[0_18px_50px_rgba(124,92,61,0.12)] backdrop-blur overflow-hidden">
          <div className="relative border-b border-amber-100/70 bg-gradient-to-br from-amber-50 via-white to-stone-50 px-6 py-8 md:px-10">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(197,143,96,0.25),transparent_35%),radial-gradient(circle_at_80%_0%,rgba(45,35,27,0.12),transparent_30%)]" aria-hidden="true" />
            ...
            <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm md:text-base text-stone-500">استعلام، مشاوره و ثبت درخواست سفارشی محصولات چرمی</div>
                </div>
              </div>
                ...
                <div className="space-y-3 text-sm text-stone-700">
                  ...
                  >
                    ...
                    <div className="flex-1 overflow-hidden">
                      ...
                      <div className="truncate text-[12px] text-rose-700/80">@bartarleather</div>
                    </div>
                    <span className="text-[11px] text-rose-700">DM</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="px-6 py-8 md:px-10">
            ...
            <Form layout="vertical" onFinish={handleSubmit} form={form}>
              <Form.Item label="نام و نام خانوادگی" name="full_name" rules={[{ required: true }]}>
                <Input placeholder="مثال: مریم رضایی" />
              </Form.Item>
              ...
              <Form.Item label="تلفن تماس" name="phone" rules={[{ required: true }]}>
