      ...
      rows: [
        {
          ...
          'تامین‌کننده مرتبط': '',
          'نرخ پرت': 5,
          'قیمت خرید واحد اصلی': 1200000,
          'قیمت خرید واحد فرعی': 12000,
          'قیمت فروش': 1500000,
          'نوع چرم': 'گاوی',
          'رنگ چرم': 'عسلی',
          'صفحه چرم': '',
...
export const buildProductionBomTemplate = (): ExcelTemplateDefinition => ({
  ...
  sheets: [
    ...
    {
      name: 'مراحل پیش نویس تولید',
      rows: [
        {
          'کلید BOM': 'BOM-A',
          'شناسه مرحله': 'stage-cut-01',
          'عنوان مرحله': 'برشکاری',
          'ترتیب': 10,
          'دستمزد': 150000,
        },
    ...
    },
    {
      name: 'راهنما',
      rows: [
        { 'موضوع': 'اتصال شیت‌ها', 'توضیح': 'ستون «کلید BOM» در شیت‌های BOM، مواد اولیه و مراحل پیش نویس تولید باید یکسان باشد.' },
        ...
        { 'موضوع': 'ساختار مراحل', 'توضیح': 'در شیت «مراحل پیش نویس تولید» هر ردیف معادل یک مرحله است. ستون «عنوان مرحله» الزامی و ستون‌های «شناسه مرحله»، «ترتیب» و «دستمزد» اختیاری هستند.' },
        { 'موضوع': 'منطق مراحل', 'توضیح': 'اگر «شناسه مرحله» خالی باشد، سیستم خودش شناسه می‌سازد. اگر «ترتیب» خالی باشد، ترتیب بر اساس ردیف‌های همان BOM با گام 10 ساخته می‌شود.' },
