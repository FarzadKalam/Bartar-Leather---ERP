...
export const customerModule: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'prefix', labels: { fa: 'پیشوند', en: 'Prefix' }, type: FieldType.SELECT, blockId: 'basic_info', options: [{label:'آقای', value:'mr'}, {label:'خانم', value:'ms'}, {label:'دکتر', value:'dr'}, {label:'مهندس', value:'eng'}] },
    ...
    { key: 'address', labels: { fa: 'آدرس پستی', en: 'Address' }, type: FieldType.TEXTAREA, blockId: 'contact_info', className: 'col-span-2' },
    ...
    { key: 'total_spend', labels: { fa: 'جمع کل خرید (ریال)', en: 'Total Spend' }, type: FieldType.PRICE, blockId: 'financial_stats', readonly: true, className: 'text-xl font-bold text-green-600' },
  ],
  blocks: [
