...
export const supplierModule: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'prefix', labels: { fa: 'پیشوند', en: 'Prefix' }, type: FieldType.SELECT, blockId: 'basic_info', options: [{label:'آقای', value:'mr'}, {label:'خانم', value:'ms'}] },
    ...
    { key: 'address', labels: { fa: 'آدرس انبار/دفتر', en: 'Address' }, type: FieldType.TEXTAREA, blockId: 'contact_info', className: 'col-span-2' },
    { key: 'location', labels: { fa: 'لوکیشن', en: 'Location' }, type: FieldType.TEXT, blockId: 'contact_info' },

    { key: 'bank_account_number', labels: { fa: 'شماره کارت/حساب', en: 'Bank Account' }, type: FieldType.TEXT, blockId: 'financial_info', className: 'font-mono' },
