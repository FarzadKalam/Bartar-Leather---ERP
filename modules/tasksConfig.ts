...
export const tasksModule: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'related_to_module', labels: { fa: 'مرتبط با بخش', en: 'Task Type' }, type: FieldType.SELECT, location: FieldLocation.HEADER, order: 6, options: [{ label: 'تولید', value: 'production_order' }, { label: 'مشتریان', value: 'customers' }, { label: 'محصولات', value: 'products' }, { label: 'تامین کنندگان', value: 'suppliers' }], validation: { required: false }, nature: FieldNature.PREDEFINED },
    ...
    // --- زمان‌بندی ---
    { key: 'start_date', labels: { fa: 'تاریخ شروع', en: 'Start Date' }, type: FieldType.DATETIME, location: FieldLocation.BLOCK, blockId: 'scheduling', order: 4, nature: FieldNature.STANDARD },
    { key: 'due_date', labels: { fa: 'مهلت انجام', en: 'Due Date' }, type: FieldType.DATETIME, location: FieldLocation.BLOCK, blockId: 'scheduling', order: 2, nature: FieldNature.STANDARD },
