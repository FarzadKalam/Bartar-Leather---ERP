...
export const tasksModule: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'related_to_module', labels: { fa: 'مرتبط با بخش', en: 'Task Type' }, type: FieldType.SELECT, location: FieldLocation.HEADER, order: 6, options: [{ label: 'تولید', value: 'production_orders' }, { label: 'مشتریان', value: 'customers' }, { label: 'محصولات', value: 'products' }, { label: 'تامین کنندگان', value: 'suppliers' }], validation: { required: false }, nature: FieldNature.PREDEFINED, isTableColumn: true },
