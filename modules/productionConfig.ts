...
export const productionOrderModule: ModuleDefinition = {
  ...
  fields: [
    ...
    {
      key: 'leather_width',
      labels: { fa: 'عرض چرم (میلیمتر)', en: 'Leather Width (mm)' },
      type: FieldType.SELECT,
      location: FieldLocation.BLOCK,
      blockId: 'leatherSpec',
      order: 20.25,
      dynamicOptionsCategory: 'leather_width',
      nature: FieldNature.STANDARD,
      logic: { visibleIf: { field: 'category', operator: LogicOperator.EQUALS, value: 'leather' } },
    },
    {
    ...
    {
      key: 'lining_type',
      labels: { fa: 'نوع آستر', en: 'Lining Type' },
      type: FieldType.SELECT,
      location: FieldLocation.BLOCK,
      blockId: 'liningSpec',
      order: 20.65,
      dynamicOptionsCategory: 'lining_type',
      nature: FieldNature.STANDARD,
      logic: { visibleIf: { field: 'category', operator: LogicOperator.EQUALS, value: 'lining' } },
    },
    {
    ...
    {
      key: 'lining_width',
      labels: { fa: 'عرض آستر (میلیمتر)', en: 'Lining Width (mm)' },
      type: FieldType.SELECT,
      location: FieldLocation.BLOCK,
      blockId: 'liningSpec',
      order: 20.8,
    ...
    {
      key: 'accessory_type',
      labels: { fa: 'نوع خرجکار', en: 'Accessory Type' },
      type: FieldType.SELECT,
      location: FieldLocation.BLOCK,
      blockId: 'kharjkarSpec',
      order: 20.93,
      dynamicOptionsCategory: 'accessory_type',
      nature: FieldNature.STANDARD,
      logic: { visibleIf: { field: 'category', operator: LogicOperator.EQUALS, value: 'accessory' } },
    },
    {
      key: 'accessory_width',
      labels: { fa: 'عرض خرجکار (میلیمتر)', en: 'Accessory Width (mm)' },
      type: FieldType.SELECT,
      location: FieldLocation.BLOCK,
      blockId: 'kharjkarSpec',
      order: 20.95,
      dynamicOptionsCategory: 'accessory_width',
      nature: FieldNature.STANDARD,
      logic: { visibleIf: { field: 'category', operator: LogicOperator.EQUALS, value: 'accessory' } },
    },
    {
