...
const fieldsArray: any[] = [
  ...
  { key: 'name', labels: { fa: 'نام محصول', en: 'Name' }, type: FieldType.TEXT, location: FieldLocation.HEADER, order: 1, validation: { required: true }, uniqueness: { enabled: true, normalization: 'trim_lower_spaces', message: 'محصولی با این نام قبلاً ثبت شده است.' }, nature: FieldNature.PREDEFINED, isTableColumn: true },
  ...
  {
    key: 'sewing_type',
    labels: { fa: 'نوع دوخت', en: 'Sewing Type' },
    type: FieldType.SELECT,
    location: FieldLocation.BLOCK,
    blockId: 'baseInfo',
    order: 2.65,
    dynamicOptionsCategory: 'sewing_type',
    nature: FieldNature.STANDARD,
    validation: { required: false },
    logic: { visibleIf: { field: 'product_type', operator: LogicOperator.NOT_EQUALS, value: 'raw' } }
  },
  {
    key: 'warranty_months',
    labels: { fa: 'مدت گارانتی (ماه)', en: 'Warranty Duration (Months)' },
  ...
  {
    key: 'after_sales_service_months',
    labels: { fa: 'مدت خدمات پس از فروش (ماه)', en: 'After-Sales Service Duration (Months)' },
    type: FieldType.NUMBER,
    location: FieldLocation.BLOCK,
    blockId: 'baseInfo',
    order: 2.67,
  ...
  {
    key: 'site_code',
    labels: { fa: 'کد سایت', en: 'Site Code' },
    type: FieldType.TEXT,
    location: FieldLocation.BLOCK,
    blockId: 'baseInfo',
    order: 2.68,
  ...
  {
    key: 'site_product_link',
    labels: { fa: 'لینک محصول در سایت', en: 'Site Product Link' },
    type: FieldType.LINK,
    location: FieldLocation.BLOCK,
    blockId: 'baseInfo',
    order: 2.69,
  ...
  { key: 'buy_price', labels: { fa: 'قیمت خرید واحد اصلی', en: 'Main Unit Buy Price' }, type: FieldType.PRICE, location: FieldLocation.BLOCK, blockId: 'baseInfo', order: 8, nature: FieldNature.PREDEFINED, isTableColumn: true },
  { key: 'sub_buy_price', labels: { fa: 'قیمت خرید واحد فرعی', en: 'Sub Unit Buy Price' }, type: FieldType.PRICE, location: FieldLocation.BLOCK, blockId: 'baseInfo', order: 8.1, nature: FieldNature.PREDEFINED, isTableColumn: true },
  ...
  return [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'برگشت فاکتور فروش', value: 'sales_invoice_cancel' },
        { label: 'فاکتور خرید', value: 'purchase_invoice' },
        { label: 'برگشت فاکتور خرید', value: 'purchase_invoice_cancel' },
